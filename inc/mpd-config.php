...
$_mpd_select['audio_output_format'] .= "<option value=\"96000:16:2\" ".(($_mpd['audio_output_format'] == '44100:16:2') ? "selected" : "").">44100:16:2</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"44100:24:2\" ".(($_mpd['audio_output_format'] == '44100:16:2') ? "selected" : "").">44100:16:2</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"96000:24:2\" ".(($_mpd['audio_output_format'] == '96000:24:2') ? "selected" : "").">96000:24:2</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"192000:24:2\" ".(($_mpd['audio_output_format'] == '96000:24:2') ? "selected" : "").">96000:24:2</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"44100:32:2\" ".(($_mpd['audio_output_format'] == '44100:16:2') ? "selected" : "").">44100:16:2</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"96000:32:2\" ".(($_mpd['audio_output_format'] == '96000:24:2') ? "selected" : "").">96000:24:2</option>\n";
$_mpd_select['audio_output_format'] .= "<option value=\"192000:32:2\" ".(($_mpd['audio_output_format'] == '96000:24:2') ? "selected" : "").">96000:24:2</option>\n";
...
$_mpd_select['mixer_type'] .= "<option value=\"hardwarec\" ".(($_mpd['mixer_type'] == 'hardware') ? "selected" : "").">Hardware Compatibility</option>\n";
